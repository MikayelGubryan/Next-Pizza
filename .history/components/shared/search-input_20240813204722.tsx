...
export const SearchInput: React.FC<Props> = ({ className }) => {
    ...
    miq xi es hanel et dran patasxanna galis paher kan inch oaher de hima asumes u qashvumes xrax ha lav lurj?
            ...
            <div 
                ...
                <Link className='flex items-center gap-3 px-3 py-2 hover:bg-primary/10' href="/product/1">
                    <img
                      ...
                      src="https://media.dodostatic.net/image/r:292x292/11EF49CDEA22CF4EA2DA4DDE0BA221FC.avif"
                      alt="Pizza 1"
                    />
                    <span className='ml-3'>Pepperoni</span>
                </Link>
