            ...
            <div 
                ...
                <Link className='flex items-center gap-3 px-3 py-2 hover:bg-primary/10' href="/product/1">
                    <Image
                      ...
                      src="https://assets.tmecosys.com/image/upload/t_web767x639/img/recipe/ras/Assets/ecaeb2cc-a950-4645-a648-9137305b3287/Derivates/df977b90-193d-49d4-a59d-8dd922bcbf65.jp" 
                      alt="Pizza 1"
                    />
